...
namespace SV
{
    public partial class Ayarlar : MetroFramework.Forms.MetroForm
    {
        ...
        private void trackBar1_MouseUp(object sender, MouseEventArgs e)
        {
            try
            {
                byte[] senddata = Form1.MyDataPacker("Ringtone", Encoding.UTF8.GetBytes(trackBar1.Value.ToString()));
                sock.Send(senddata, 0, senddata.Length, SocketFlags.None);
                yenile();
            }
            catch (Exception) { }
        ...
        private void trackBar2_MouseUp(object sender, MouseEventArgs e)
        {
            try
            {
                byte[] senddata = Form1.MyDataPacker("Media", Encoding.UTF8.GetBytes(trackBar2.Value.ToString()));
                sock.Send(senddata, 0, senddata.Length, SocketFlags.None);
                yenile();
            }
            catch (Exception) { }
        ...
        private void trackBar3_MouseUp(object sender, MouseEventArgs e)
        {
            try
            {
                byte[] senddata = Form1.MyDataPacker("Notification", Encoding.UTF8.GetBytes(trackBar3.Value.ToString()));
                sock.Send(senddata, 0, senddata.Length, SocketFlags.None);
                yenile();
            }
            catch (Exception) { }
        ...
        private void trackBar4_MouseUp(object sender, MouseEventArgs e)
        {
            try
            {
                byte[] senddata = Form1.MyDataPacker("Screen Brightness", Encoding.UTF8.GetBytes(trackBar4.Value.ToString()));
                sock.Send(senddata, 0, senddata.Length, SocketFlags.None);
                yenile();
            }
            catch (Exception) { }
