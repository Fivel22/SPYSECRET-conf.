; ModuleID = 'C:\Users\Anton\Desktop\SPYSECRET-MASTER\Server\SV\bin\Debug\outs\20230420122342\tht\obj\android\typemaps.x86_64.ll'
source_filename = "C:\Users\Anton\Desktop\SPYSECRET-MASTER\Server\SV\bin\Debug\outs\20230420122342\tht\obj\android\typemaps.x86_64.ll"
...
@module0_managed_to_java = internal constant [293 x %struct.TypeMapModuleEntry] [
	; 0
...
@module0_managed_to_java_duplicates = internal constant [112 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
...
@__TypeMapModule_assembly_name.1 = internal constant [14 x i8] c"ServicesDemo3\00", align 1
@__TypeMapModule_assembly_name.2 = internal constant [44 x i8] c"Xamarin.Android.Support.VersionedParcelable\00", align 16
...
@map_modules = global [5 x %struct.TypeMapModule] [
	...
	%struct.TypeMapModule {
		[16 x i8] c"\22\FA\B4\F2\838\C7F\93'\EFY\9E\D9\D1\A8", ; module_uuid: f2b4fa22-3883-46c7-9327-ef599ed9d1a8
		i32 293, ; entry_count
		i32 112, ; duplicate_count
		%struct.TypeMapModuleEntry* getelementptr inbounds ([293 x %struct.TypeMapModuleEntry], [293 x %struct.TypeMapModuleEntry]* @module0_managed_to_java, i32 0, i32 0), ; map
		%struct.TypeMapModuleEntry* getelementptr inbounds ([112 x %struct.TypeMapModuleEntry], [112 x %struct.TypeMapModuleEntry]* @module0_managed_to_java_duplicates, i32 0, i32 0), ; duplicate_map
	...
	; 1
	%struct.TypeMapModule {
		[16 x i8] c"&\B7\DDjk\AB\87G\8B\9C2\08Ik1\07", ; module_uuid: 6addb726-ab6b-4787-8b9c-3208496b3107
		i32 15, ; entry_count
		...
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__TypeMapModule_assembly_name.1, i32 0, i32 0), ; assembly_name: ServicesDemo3
		%struct.MonoImage* null, ; image
		i32 0, ; java_name_width
		i8* null; java_map
	}, 
	; 2
	%struct.TypeMapModule {
		[16 x i8] c"\BB\C2\C8#4\CB\95N\A6Q\92s\09t\03\CE", ; module_uuid: 23c8c2bb-cb34-4e95-a651-9273097403ce
		i32 2, ; entry_count
		...
		i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__TypeMapModule_assembly_name.2, i32 0, i32 0), ; assembly_name: Xamarin.Android.Support.VersionedParcelable
		%struct.MonoImage* null, ; image
		i32 0, ; java_name_width
		i8* null; java_map
	}, 
	; 3
	%struct.TypeMapModule {
		[16 x i8] c"\BDd\F3\F4\A7\22\12I\AE\13\A9\88;\D6z\A0", ; module_uuid: f4f364bd-22a7-4912-ae13-a9883bd67aa0
		i32 11, ; entry_count
		i32 1, ; duplicate_count
	...
	; 4
	%struct.TypeMapModule {
		[16 x i8] c"\D5\9A\88\DC\87\14\B3C\8Bl\133H\0F\8F\FA", ; module_uuid: dc889ad5-1487-43b3-8b6c-1333480f8ffa
		i32 3, ; entry_count
		i32 0, ; duplicate_count
...
; java_type_names
@__java_type_names.0 = internal constant [27 x i8] c"javax/net/ssl/TrustManager\00", align 16
@__java_type_names.1 = internal constant [31 x i8] c"javax/net/ssl/X509TrustManager\00", align 16
@__java_type_names.2 = internal constant [34 x i8] c"javax/net/ssl/TrustManagerFactory\00", align 16
@__java_type_names.3 = internal constant [27 x i8] c"android/webkit/MimeTypeMap\00", align 16
@__java_type_names.4 = internal constant [32 x i8] c"android/speech/tts/TextToSpeech\00", align 16
@__java_type_names.5 = internal constant [47 x i8] c"android/speech/tts/TextToSpeech$OnInitListener\00", align 16
@__java_type_names.6 = internal constant [61 x i8] c"android/speech/tts/TextToSpeech$OnUtteranceCompletedListener\00", align 16
@__java_type_names.7 = internal constant [25 x i8] c"android/provider/CallLog\00", align 16
@__java_type_names.8 = internal constant [31 x i8] c"android/provider/CallLog$Calls\00", align 16
@__java_type_names.9 = internal constant [34 x i8] c"android/provider/ContactsContract\00", align 16
@__java_type_names.10 = internal constant [50 x i8] c"android/provider/ContactsContract$CommonDataKinds\00", align 16
@__java_type_names.11 = internal constant [56 x i8] c"android/provider/ContactsContract$CommonDataKinds$Phone\00", align 16
@__java_type_names.12 = internal constant [43 x i8] c"android/provider/ContactsContract$Contacts\00", align 16
@__java_type_names.13 = internal constant [39 x i8] c"android/provider/ContactsContract$Data\00", align 16
@__java_type_names.14 = internal constant [46 x i8] c"android/provider/ContactsContract$PhoneLookup\00", align 16
@__java_type_names.15 = internal constant [46 x i8] c"android/provider/ContactsContract$RawContacts\00", align 16
@__java_type_names.16 = internal constant [26 x i8] c"android/provider/Settings\00", align 16
@__java_type_names.17 = internal constant [33 x i8] c"android/provider/Settings$Global\00", align 16
@__java_type_names.18 = internal constant [41 x i8] c"android/provider/Settings$NameValueTable\00", align 16
@__java_type_names.19 = internal constant [33 x i8] c"android/provider/Settings$Secure\00", align 16
@__java_type_names.20 = internal constant [33 x i8] c"android/provider/Settings$System\00", align 16
@__java_type_names.21 = internal constant [27 x i8] c"android/provider/Telephony\00", align 16
@__java_type_names.22 = internal constant [31 x i8] c"android/provider/Telephony$Sms\00", align 16
@__java_type_names.23 = internal constant [37 x i8] c"android/provider/Telephony$Sms$Inbox\00", align 16
@__java_type_names.24 = internal constant [36 x i8] c"android/provider/Telephony$Sms$Sent\00", align 16
@__java_type_names.25 = internal constant [33 x i8] c"android/database/CharArrayBuffer\00", align 16
@__java_type_names.26 = internal constant [33 x i8] c"android/database/ContentObserver\00", align 16
@__java_type_names.27 = internal constant [33 x i8] c"android/database/DataSetObserver\00", align 16
@__java_type_names.28 = internal constant [24 x i8] c"android/database/Cursor\00", align 16
@__java_type_names.29 = internal constant [50 x i8] c"android/accessibilityservice/AccessibilityService\00", align 16
@__java_type_names.30 = internal constant [54 x i8] c"android/accessibilityservice/AccessibilityServiceInfo\00", align 16
@__java_type_names.31 = internal constant [21 x i8] c"android/widget/Toast\00", align 16
@__java_type_names.32 = internal constant [18 x i8] c"android/view/View\00", align 16
@__java_type_names.33 = internal constant [46 x i8] c"android/view/View$OnCreateContextMenuListener\00", align 16
@__java_type_names.34 = internal constant [22 x i8] c"android/view/KeyEvent\00", align 16
@__java_type_names.35 = internal constant [31 x i8] c"android/view/KeyEvent$Callback\00", align 16
@__java_type_names.36 = internal constant [28 x i8] c"android/view/LayoutInflater\00", align 16
@__java_type_names.37 = internal constant [36 x i8] c"android/view/LayoutInflater$Factory\00", align 16
@__java_type_names.38 = internal constant [37 x i8] c"android/view/LayoutInflater$Factory2\00", align 16
@__java_type_names.39 = internal constant [25 x i8] c"android/view/MotionEvent\00", align 16
@__java_type_names.40 = internal constant [20 x i8] c"android/view/Window\00", align 16
@__java_type_names.41 = internal constant [29 x i8] c"android/view/Window$Callback\00", align 16
@__java_type_names.42 = internal constant [24 x i8] c"android/view/ActionMode\00", align 16
@__java_type_names.43 = internal constant [33 x i8] c"android/view/ActionMode$Callback\00", align 16
@__java_type_names.44 = internal constant [28 x i8] c"android/view/ActionProvider\00", align 16
@__java_type_names.45 = internal constant [33 x i8] c"android/view/ContextThemeWrapper\00", align 16
@__java_type_names.46 = internal constant [21 x i8] c"android/view/Display\00", align 16
@__java_type_names.47 = internal constant [23 x i8] c"android/view/DragEvent\00", align 16
@__java_type_names.48 = internal constant [41 x i8] c"android/view/ContextMenu$ContextMenuInfo\00", align 16
@__java_type_names.49 = internal constant [25 x i8] c"android/view/ContextMenu\00", align 16
@__java_type_names.50 = internal constant [18 x i8] c"android/view/Menu\00", align 16
@__java_type_names.51 = internal constant [45 x i8] c"android/view/MenuItem$OnActionExpandListener\00", align 16
@__java_type_names.52 = internal constant [46 x i8] c"android/view/MenuItem$OnMenuItemClickListener\00", align 16
@__java_type_names.53 = internal constant [22 x i8] c"android/view/MenuItem\00", align 16
@__java_type_names.54 = internal constant [24 x i8] c"android/view/InputEvent\00", align 16
@__java_type_names.55 = internal constant [21 x i8] c"android/view/SubMenu\00", align 16
@__java_type_names.56 = internal constant [36 x i8] c"android/view/SurfaceHolder$Callback\00", align 16
@__java_type_names.57 = internal constant [27 x i8] c"android/view/SurfaceHolder\00", align 16
@__java_type_names.58 = internal constant [25 x i8] c"android/view/ViewManager\00", align 16
@__java_type_names.59 = internal constant [24 x i8] c"android/view/ViewParent\00", align 16
@__java_type_names.60 = internal constant [40 x i8] c"android/view/WindowManager$LayoutParams\00", align 16
@__java_type_names.61 = internal constant [27 x i8] c"android/view/WindowManager\00", align 16
@__java_type_names.62 = internal constant [38 x i8] c"android/view/OrientationEventListener\00", align 16
@__java_type_names.63 = internal constant [25 x i8] c"android/view/SearchEvent\00", align 16
@__java_type_names.64 = internal constant [21 x i8] c"android/view/Surface\00", align 16
@__java_type_names.65 = internal constant [25 x i8] c"android/view/SurfaceView\00", align 16
@__java_type_names.66 = internal constant [23 x i8] c"android/view/ViewGroup\00", align 16
@__java_type_names.67 = internal constant [36 x i8] c"android/view/ViewGroup$LayoutParams\00", align 16
@__java_type_names.68 = internal constant [46 x i8] c"android/view/accessibility/AccessibilityEvent\00", align 16
@__java_type_names.69 = internal constant [47 x i8] c"android/view/accessibility/AccessibilityRecord\00", align 16
@__java_type_names.70 = internal constant [52 x i8] c"android/view/accessibility/AccessibilityEventSource\00", align 16
@__java_type_names.71 = internal constant [28 x i8] c"android/util/DisplayMetrics\00", align 16
@__java_type_names.72 = internal constant [26 x i8] c"android/util/AttributeSet\00", align 16
@__java_type_names.73 = internal constant [30 x i8] c"android/text/ClipboardManager\00", align 16
@__java_type_names.74 = internal constant [35 x i8] c"android/telephony/TelephonyManager\00", align 16
@__java_type_names.75 = internal constant [29 x i8] c"android/telephony/SmsManager\00", align 16
@__java_type_names.76 = internal constant [29 x i8] c"android/telephony/SmsMessage\00", align 16
@__java_type_names.77 = internal constant [37 x i8] c"android/preference/PreferenceManager\00", align 16
@__java_type_names.78 = internal constant [19 x i8] c"android/os/Handler\00", align 16
@__java_type_names.79 = internal constant [24 x i8] c"android/os/PowerManager\00", align 16
@__java_type_names.80 = internal constant [33 x i8] c"android/os/PowerManager$WakeLock\00", align 16
@__java_type_names.81 = internal constant [20 x i8] c"android/os/Vibrator\00", align 16
@__java_type_names.82 = internal constant [22 x i8] c"android/os/BaseBundle\00", align 16
@__java_type_names.83 = internal constant [17 x i8] c"android/os/Build\00", align 16
@__java_type_names.84 = internal constant [25 x i8] c"android/os/Build$VERSION\00", align 16
@__java_type_names.85 = internal constant [18 x i8] c"android/os/Bundle\00", align 16
@__java_type_names.86 = internal constant [23 x i8] c"android/os/Environment\00", align 16
@__java_type_names.87 = internal constant [34 x i8] c"android/os/IBinder$DeathRecipient\00", align 16
@__java_type_names.88 = internal constant [19 x i8] c"android/os/IBinder\00", align 16
@__java_type_names.89 = internal constant [22 x i8] c"android/os/IInterface\00", align 16
@__java_type_names.90 = internal constant [22 x i8] c"android/os/Parcelable\00", align 16
@__java_type_names.91 = internal constant [18 x i8] c"android/os/Looper\00", align 16
@__java_type_names.92 = internal constant [18 x i8] c"android/os/Parcel\00", align 16
@__java_type_names.93 = internal constant [19 x i8] c"android/os/Process\00", align 16
@__java_type_names.94 = internal constant [32 x i8] c"android/net/ConnectivityManager\00", align 16
@__java_type_names.95 = internal constant [24 x i8] c"android/net/NetworkInfo\00", align 16
@__java_type_names.96 = internal constant [30 x i8] c"android/net/NetworkInfo$State\00", align 16
@__java_type_names.97 = internal constant [16 x i8] c"android/net/Uri\00", align 16
@__java_type_names.98 = internal constant [29 x i8] c"android/net/wifi/WifiManager\00", align 16
@__java_type_names.99 = internal constant [26 x i8] c"android/net/wifi/WifiInfo\00", align 16
@__java_type_names.100 = internal constant [27 x i8] c"android/media/AudioManager\00", align 16
@__java_type_names.101 = internal constant [26 x i8] c"android/media/AudioRecord\00", align 16
@__java_type_names.102 = internal constant [26 x i8] c"android/media/MediaPlayer\00", align 16
@__java_type_names.103 = internal constant [20 x i8] c"android/media/Image\00", align 16
@__java_type_names.104 = internal constant [26 x i8] c"android/media/Image$Plane\00", align 16
@__java_type_names.105 = internal constant [26 x i8] c"android/media/ImageReader\00", align 16
@__java_type_names.106 = internal constant [51 x i8] c"android/media/ImageReader$OnImageAvailableListener\00", align 16
@__java_type_names.107 = internal constant [31 x i8] c"android/media/VolumeAutomation\00", align 16
@__java_type_names.108 = internal constant [27 x i8] c"android/media/VolumeShaper\00", align 16
@__java_type_names.109 = internal constant [41 x i8] c"android/media/VolumeShaper$Configuration\00", align 16
@__java_type_names.110 = internal constant [41 x i8] c"android/media/projection/MediaProjection\00", align 16
@__java_type_names.111 = internal constant [50 x i8] c"android/media/projection/MediaProjection$Callback\00", align 16
@__java_type_names.112 = internal constant [48 x i8] c"android/media/projection/MediaProjectionManager\00", align 16
@__java_type_names.113 = internal constant [33 x i8] c"android/location/LocationManager\00", align 16
@__java_type_names.114 = internal constant [25 x i8] c"android/location/Address\00", align 16
@__java_type_names.115 = internal constant [26 x i8] c"android/location/Criteria\00", align 16
@__java_type_names.116 = internal constant [26 x i8] c"android/location/Geocoder\00", align 16
@__java_type_names.117 = internal constant [34 x i8] c"android/location/LocationListener\00", align 16
@__java_type_names.118 = internal constant [26 x i8] c"android/location/Location\00", align 16
@__java_type_names.119 = internal constant [24 x i8] c"android/hardware/Camera\00", align 16
@__java_type_names.120 = internal constant [35 x i8] c"android/hardware/Camera$CameraInfo\00", align 16
@__java_type_names.121 = internal constant [35 x i8] c"android/hardware/Camera$Parameters\00", align 16
@__java_type_names.122 = internal constant [40 x i8] c"android/hardware/Camera$PreviewCallback\00", align 16
@__java_type_names.123 = internal constant [29 x i8] c"android/hardware/Camera$Size\00", align 16
@__java_type_names.124 = internal constant [40 x i8] c"android/hardware/display/VirtualDisplay\00", align 16
@__java_type_names.125 = internal constant [49 x i8] c"android/hardware/display/VirtualDisplay$Callback\00", align 16
@__java_type_names.126 = internal constant [47 x i8] c"android/hardware/camera2/CameraCharacteristics\00", align 16
@__java_type_names.127 = internal constant [51 x i8] c"android/hardware/camera2/CameraCharacteristics$Key\00", align 16
@__java_type_names.128 = internal constant [39 x i8] c"android/hardware/camera2/CameraManager\00", align 16
@__java_type_names.129 = internal constant [40 x i8] c"android/hardware/camera2/CameraMetadata\00", align 16
@__java_type_names.130 = internal constant [24 x i8] c"android/graphics/Bitmap\00", align 16
@__java_type_names.131 = internal constant [39 x i8] c"android/graphics/Bitmap$CompressFormat\00", align 16
@__java_type_names.132 = internal constant [31 x i8] c"android/graphics/Bitmap$Config\00", align 16
@__java_type_names.133 = internal constant [24 x i8] c"android/graphics/Canvas\00", align 16
@__java_type_names.134 = internal constant [31 x i8] c"android/graphics/BitmapFactory\00", align 16
@__java_type_names.135 = internal constant [39 x i8] c"android/graphics/BitmapFactory$Options\00", align 16
@__java_type_names.136 = internal constant [24 x i8] c"android/graphics/Matrix\00", align 16
@__java_type_names.137 = internal constant [23 x i8] c"android/graphics/Point\00", align 16
@__java_type_names.138 = internal constant [28 x i8] c"android/graphics/PorterDuff\00", align 16
@__java_type_names.139 = internal constant [33 x i8] c"android/graphics/PorterDuff$Mode\00", align 16
@__java_type_names.140 = internal constant [22 x i8] c"android/graphics/Rect\00", align 16
@__java_type_names.141 = internal constant [23 x i8] c"android/graphics/RectF\00", align 16
@__java_type_names.142 = internal constant [32 x i8] c"android/graphics/SurfaceTexture\00", align 16
@__java_type_names.143 = internal constant [26 x i8] c"android/graphics/YuvImage\00", align 16
@__java_type_names.144 = internal constant [35 x i8] c"android/graphics/drawable/Drawable\00", align 16
@__java_type_names.145 = internal constant [44 x i8] c"android/graphics/drawable/Drawable$Callback\00", align 16
@__java_type_names.146 = internal constant [41 x i8] c"android/graphics/drawable/BitmapDrawable\00", align 16
@__java_type_names.147 = internal constant [31 x i8] c"android/graphics/drawable/Icon\00", align 16
@__java_type_names.148 = internal constant [35 x i8] c"android/bluetooth/BluetoothAdapter\00", align 16
@__java_type_names.149 = internal constant [21 x i8] c"android/app/Activity\00", align 16
@__java_type_names.150 = internal constant [28 x i8] c"android/app/ActivityManager\00", align 16
@__java_type_names.151 = internal constant [39 x i8] c"android/app/ActivityManager$MemoryInfo\00", align 16
@__java_type_names.152 = internal constant [25 x i8] c"android/app/AlarmManager\00", align 16
@__java_type_names.153 = internal constant [24 x i8] c"android/app/Application\00", align 16
@__java_type_names.154 = internal constant [51 x i8] c"android/app/Application$ActivityLifecycleCallbacks\00", align 16
@__java_type_names.155 = internal constant [25 x i8] c"android/app/Notification\00", align 16
@__java_type_names.156 = internal constant [33 x i8] c"android/app/Notification$Builder\00", align 16
@__java_type_names.157 = internal constant [32 x i8] c"android/app/NotificationManager\00", align 16
@__java_type_names.158 = internal constant [28 x i8] c"android/app/KeyguardManager\00", align 16
@__java_type_names.159 = internal constant [32 x i8] c"android/app/NotificationChannel\00", align 16
@__java_type_names.160 = internal constant [26 x i8] c"android/app/PendingIntent\00", align 16
@__java_type_names.161 = internal constant [20 x i8] c"android/app/Service\00", align 16
@__java_type_names.162 = internal constant [29 x i8] c"android/app/WallpaperManager\00", align 16
@__java_type_names.163 = internal constant [38 x i8] c"android/app/admin/DevicePolicyManager\00", align 16
@__java_type_names.164 = internal constant [38 x i8] c"android/app/admin/DeviceAdminReceiver\00", align 16
@__java_type_names.165 = internal constant [24 x i8] c"android/content/Context\00", align 16
@__java_type_names.166 = internal constant [29 x i8] c"android/content/CursorLoader\00", align 16
@__java_type_names.167 = internal constant [23 x i8] c"android/content/Intent\00", align 16
@__java_type_names.168 = internal constant [32 x i8] c"android/content/AsyncTaskLoader\00", align 16
@__java_type_names.169 = internal constant [34 x i8] c"android/content/BroadcastReceiver\00", align 16
@__java_type_names.170 = internal constant [33 x i8] c"android/content/ClipboardManager\00", align 16
@__java_type_names.171 = internal constant [25 x i8] c"android/content/ClipData\00", align 16
@__java_type_names.172 = internal constant [30 x i8] c"android/content/ClipData$Item\00", align 16
@__java_type_names.173 = internal constant [30 x i8] c"android/content/ComponentName\00", align 16
@__java_type_names.174 = internal constant [41 x i8] c"android/content/ContentProviderOperation\00", align 16
@__java_type_names.175 = internal constant [49 x i8] c"android/content/ContentProviderOperation$Builder\00", align 16
@__java_type_names.176 = internal constant [38 x i8] c"android/content/ContentProviderResult\00", align 16
@__java_type_names.177 = internal constant [32 x i8] c"android/content/ContentResolver\00", align 16
@__java_type_names.178 = internal constant [31 x i8] c"android/content/ContextWrapper\00", align 16
@__java_type_names.179 = internal constant [35 x i8] c"android/content/ComponentCallbacks\00", align 16
@__java_type_names.180 = internal constant [36 x i8] c"android/content/ComponentCallbacks2\00", align 16
@__java_type_names.181 = internal constant [29 x i8] c"android/content/IntentFilter\00", align 16
@__java_type_names.182 = internal constant [29 x i8] c"android/content/IntentSender\00", align 16
@__java_type_names.183 = internal constant [41 x i8] c"android/content/SharedPreferences$Editor\00", align 16
@__java_type_names.184 = internal constant [67 x i8] c"android/content/SharedPreferences$OnSharedPreferenceChangeListener\00", align 16
@__java_type_names.185 = internal constant [34 x i8] c"android/content/SharedPreferences\00", align 16
@__java_type_names.186 = internal constant [23 x i8] c"android/content/Loader\00", align 16
@__java_type_names.187 = internal constant [35 x i8] c"android/content/pm/ApplicationInfo\00", align 16
@__java_type_names.188 = internal constant [31 x i8] c"android/content/pm/FeatureInfo\00", align 16
@__java_type_names.189 = internal constant [31 x i8] c"android/content/pm/PackageInfo\00", align 16
@__java_type_names.190 = internal constant [35 x i8] c"android/content/pm/PackageItemInfo\00", align 16
@__java_type_names.191 = internal constant [34 x i8] c"android/content/pm/PackageManager\00", align 16
@__java_type_names.192 = internal constant [31 x i8] c"android/content/pm/ResolveInfo\00", align 16
@__java_type_names.193 = internal constant [32 x i8] c"android/content/pm/ShortcutInfo\00", align 16
@__java_type_names.194 = internal constant [35 x i8] c"android/content/res/ColorStateList\00", align 16
@__java_type_names.195 = internal constant [34 x i8] c"android/content/res/Configuration\00", align 16
@__java_type_names.196 = internal constant [30 x i8] c"android/content/res/Resources\00", align 16
@__java_type_names.197 = internal constant [40 x i8] c"mono/android/runtime/InputStreamAdapter\00", align 16
@__java_type_names.198 = internal constant [31 x i8] c"mono/android/runtime/JavaArray\00", align 16
@__java_type_names.199 = internal constant [21 x i8] c"java/util/Collection\00", align 16
@__java_type_names.200 = internal constant [18 x i8] c"java/util/HashMap\00", align 16
@__java_type_names.201 = internal constant [20 x i8] c"java/util/ArrayList\00", align 16
@__java_type_names.202 = internal constant [32 x i8] c"mono/android/runtime/JavaObject\00", align 16
@__java_type_names.203 = internal constant [35 x i8] c"android/runtime/JavaProxyThrowable\00", align 16
@__java_type_names.204 = internal constant [18 x i8] c"java/util/HashSet\00", align 16
@__java_type_names.205 = internal constant [41 x i8] c"mono/android/runtime/OutputStreamAdapter\00", align 16
@__java_type_names.206 = internal constant [27 x i8] c"java/net/InetSocketAddress\00", align 16
@__java_type_names.207 = internal constant [15 x i8] c"java/net/Proxy\00", align 1
@__java_type_names.208 = internal constant [23 x i8] c"java/net/ProxySelector\00", align 16
@__java_type_names.209 = internal constant [23 x i8] c"java/net/SocketAddress\00", align 16
@__java_type_names.210 = internal constant [13 x i8] c"java/net/URI\00", align 1
@__java_type_names.211 = internal constant [19 x i8] c"java/util/Iterator\00", align 16
@__java_type_names.212 = internal constant [17 x i8] c"java/util/Locale\00", align 16
@__java_type_names.213 = internal constant [23 x i8] c"java/security/KeyStore\00", align 16
@__java_type_names.214 = internal constant [42 x i8] c"java/security/KeyStore$LoadStoreParameter\00", align 16
@__java_type_names.215 = internal constant [43 x i8] c"java/security/KeyStore$ProtectionParameter\00", align 16
@__java_type_names.216 = internal constant [31 x i8] c"java/security/cert/Certificate\00", align 16
@__java_type_names.217 = internal constant [38 x i8] c"java/security/cert/CertificateFactory\00", align 16
@__java_type_names.218 = internal constant [33 x i8] c"java/security/cert/X509Extension\00", align 16
@__java_type_names.219 = internal constant [35 x i8] c"java/security/cert/X509Certificate\00", align 16
@__java_type_names.220 = internal constant [16 x i8] c"java/nio/Buffer\00", align 16
@__java_type_names.221 = internal constant [20 x i8] c"java/nio/CharBuffer\00", align 16
@__java_type_names.222 = internal constant [20 x i8] c"java/nio/ByteBuffer\00", align 16
@__java_type_names.223 = internal constant [30 x i8] c"java/nio/channels/FileChannel\00", align 16
@__java_type_names.224 = internal constant [30 x i8] c"java/nio/channels/ByteChannel\00", align 16
@__java_type_names.225 = internal constant [26 x i8] c"java/nio/channels/Channel\00", align 16
@__java_type_names.226 = internal constant [39 x i8] c"java/nio/channels/GatheringByteChannel\00", align 16
@__java_type_names.227 = internal constant [39 x i8] c"java/nio/channels/InterruptibleChannel\00", align 16
@__java_type_names.228 = internal constant [38 x i8] c"java/nio/channels/ReadableByteChannel\00", align 16
@__java_type_names.229 = internal constant [40 x i8] c"java/nio/channels/ScatteringByteChannel\00", align 16
@__java_type_names.230 = internal constant [38 x i8] c"java/nio/channels/SeekableByteChannel\00", align 16
@__java_type_names.231 = internal constant [38 x i8] c"java/nio/channels/WritableByteChannel\00", align 16
@__java_type_names.232 = internal constant [51 x i8] c"java/nio/channels/spi/AbstractInterruptibleChannel\00", align 16
@__java_type_names.233 = internal constant [18 x i8] c"java/lang/Boolean\00", align 16
@__java_type_names.234 = internal constant [15 x i8] c"java/lang/Byte\00", align 1
@__java_type_names.235 = internal constant [20 x i8] c"java/lang/Character\00", align 16
@__java_type_names.236 = internal constant [16 x i8] c"java/lang/Class\00", align 16
@__java_type_names.237 = internal constant [33 x i8] c"java/lang/ClassNotFoundException\00", align 16
@__java_type_names.238 = internal constant [17 x i8] c"java/lang/Double\00", align 16
@__java_type_names.239 = internal constant [20 x i8] c"java/lang/Exception\00", align 16
@__java_type_names.240 = internal constant [16 x i8] c"java/lang/Float\00", align 16
@__java_type_names.241 = internal constant [23 x i8] c"java/lang/CharSequence\00", align 16
@__java_type_names.242 = internal constant [18 x i8] c"java/lang/Integer\00", align 16
@__java_type_names.243 = internal constant [15 x i8] c"java/lang/Long\00", align 1
@__java_type_names.244 = internal constant [17 x i8] c"java/lang/Object\00", align 16
@__java_type_names.245 = internal constant [27 x i8] c"java/lang/RuntimeException\00", align 16
@__java_type_names.246 = internal constant [16 x i8] c"java/lang/Short\00", align 16
@__java_type_names.247 = internal constant [17 x i8] c"java/lang/String\00", align 16
@__java_type_names.248 = internal constant [17 x i8] c"java/lang/Thread\00", align 16
@__java_type_names.249 = internal constant [35 x i8] c"mono/java/lang/RunnableImplementor\00", align 16
@__java_type_names.250 = internal constant [20 x i8] c"java/lang/Throwable\00", align 16
@__java_type_names.251 = internal constant [29 x i8] c"java/lang/ClassCastException\00", align 16
@__java_type_names.252 = internal constant [15 x i8] c"java/lang/Enum\00", align 1
@__java_type_names.253 = internal constant [16 x i8] c"java/lang/Error\00", align 16
@__java_type_names.254 = internal constant [21 x i8] c"java/lang/Appendable\00", align 16
@__java_type_names.255 = internal constant [24 x i8] c"java/lang/AutoCloseable\00", align 16
@__java_type_names.256 = internal constant [20 x i8] c"java/lang/Cloneable\00", align 16
@__java_type_names.257 = internal constant [21 x i8] c"java/lang/Comparable\00", align 16
@__java_type_names.258 = internal constant [35 x i8] c"java/lang/IllegalArgumentException\00", align 16
@__java_type_names.259 = internal constant [32 x i8] c"java/lang/IllegalStateException\00", align 16
@__java_type_names.260 = internal constant [36 x i8] c"java/lang/IndexOutOfBoundsException\00", align 16
@__java_type_names.261 = internal constant [19 x i8] c"java/lang/Readable\00", align 16
@__java_type_names.262 = internal constant [19 x i8] c"java/lang/Runnable\00", align 16
@__java_type_names.263 = internal constant [17 x i8] c"java/lang/System\00", align 16
@__java_type_names.264 = internal constant [23 x i8] c"java/lang/LinkageError\00", align 16
@__java_type_names.265 = internal constant [31 x i8] c"java/lang/NoClassDefFoundError\00", align 16
@__java_type_names.266 = internal constant [31 x i8] c"java/lang/NullPointerException\00", align 16
@__java_type_names.267 = internal constant [17 x i8] c"java/lang/Number\00", align 16
@__java_type_names.268 = internal constant [18 x i8] c"java/lang/Process\00", align 16
@__java_type_names.269 = internal constant [39 x i8] c"java/lang/ReflectiveOperationException\00", align 16
@__java_type_names.270 = internal constant [18 x i8] c"java/lang/Runtime\00", align 16
@__java_type_names.271 = internal constant [40 x i8] c"java/lang/UnsupportedOperationException\00", align 16
@__java_type_names.272 = internal constant [32 x i8] c"java/lang/annotation/Annotation\00", align 16
@__java_type_names.273 = internal constant [35 x i8] c"java/lang/reflect/AnnotatedElement\00", align 16
@__java_type_names.274 = internal constant [37 x i8] c"java/lang/reflect/GenericDeclaration\00", align 16
@__java_type_names.275 = internal constant [23 x i8] c"java/lang/reflect/Type\00", align 16
@__java_type_names.276 = internal constant [31 x i8] c"java/lang/reflect/TypeVariable\00", align 16
@__java_type_names.277 = internal constant [23 x i8] c"java/io/BufferedReader\00", align 16
@__java_type_names.278 = internal constant [13 x i8] c"java/io/File\00", align 1
@__java_type_names.279 = internal constant [23 x i8] c"java/io/FileDescriptor\00", align 16
@__java_type_names.280 = internal constant [24 x i8] c"java/io/FileInputStream\00", align 16
@__java_type_names.281 = internal constant [18 x i8] c"java/io/Closeable\00", align 16
@__java_type_names.282 = internal constant [18 x i8] c"java/io/Flushable\00", align 16
@__java_type_names.283 = internal constant [20 x i8] c"java/io/InputStream\00", align 16
@__java_type_names.284 = internal constant [26 x i8] c"java/io/InputStreamReader\00", align 16
@__java_type_names.285 = internal constant [20 x i8] c"java/io/IOException\00", align 16
@__java_type_names.286 = internal constant [21 x i8] c"java/io/Serializable\00", align 16
@__java_type_names.287 = internal constant [21 x i8] c"java/io/OutputStream\00", align 16
@__java_type_names.288 = internal constant [20 x i8] c"java/io/PrintWriter\00", align 16
@__java_type_names.289 = internal constant [15 x i8] c"java/io/Reader\00", align 1
@__java_type_names.290 = internal constant [21 x i8] c"java/io/StringWriter\00", align 16
@__java_type_names.291 = internal constant [15 x i8] c"java/io/Writer\00", align 1
@__java_type_names.292 = internal constant [25 x i8] c"mono/android/TypeManager\00", align 16
@__java_type_names.293 = internal constant [19 x i8] c"izci/AdminReceiver\00", align 16
@__java_type_names.294 = internal constant [28 x i8] c"crc646c638bcfc2425995/Alarm\00", align 16
@__java_type_names.295 = internal constant [35 x i8] c"crc646c638bcfc2425995/BootReceiver\00", align 16
@__java_type_names.296 = internal constant [45 x i8] c"crc646c638bcfc2425995/ImageAvailableListener\00", align 16
@__java_type_names.297 = internal constant [32 x i8] c"crc646c638bcfc2425995/KeyListen\00", align 16
@__java_type_names.298 = internal constant [50 x i8] c"crc646c638bcfc2425995/MediaProjectionStopCallback\00", align 16
@__java_type_names.299 = internal constant [48 x i8] c"crc646c638bcfc2425995/OrientationChangeCallback\00", align 16
@__java_type_names.300 = internal constant [40 x i8] c"crc646c638bcfc2425995/PhonecallReceiver\00", align 16
@__java_type_names.301 = internal constant [35 x i8] c"crc646c638bcfc2425995/MainActivity\00", align 16
@__java_type_names.302 = internal constant [27 x i8] c"crc646c638bcfc2425995/Prev\00", align 16
@__java_type_names.303 = internal constant [40 x i8] c"crc646c638bcfc2425995/ForegroundService\00", align 16
@__java_type_names.304 = internal constant [36 x i8] c"crc646c638bcfc2425995/screenActivty\00", align 16
@__java_type_names.305 = internal constant [35 x i8] c"crc646c638bcfc2425995/ScreenStatus\00", align 16
@__java_type_names.306 = internal constant [43 x i8] c"crc646c638bcfc2425995/SMSBroadcastReceiver\00", align 16
@__java_type_names.307 = internal constant [32 x i8] c"crc646c638bcfc2425995/SMSSTATUS\00", align 16
@__java_type_names.308 = internal constant [55 x i8] c"androidx/versionedparcelable/CustomVersionedParcelable\00", align 16
@__java_type_names.309 = internal constant [49 x i8] c"androidx/versionedparcelable/VersionedParcelable\00", align 16
@__java_type_names.310 = internal constant [54 x i8] c"android/support/v13/view/DragAndDropPermissionsCompat\00", align 16
@__java_type_names.311 = internal constant [48 x i8] c"android/support/v4/graphics/drawable/IconCompat\00", align 16
@__java_type_names.312 = internal constant [41 x i8] c"android/support/v4/content/ContextCompat\00", align 16
@__java_type_names.313 = internal constant [45 x i8] c"android/support/v4/content/PermissionChecker\00", align 16
@__java_type_names.314 = internal constant [49 x i8] c"android/support/v4/content/pm/ShortcutInfoCompat\00", align 16
@__java_type_names.315 = internal constant [57 x i8] c"android/support/v4/content/pm/ShortcutInfoCompat$Builder\00", align 16
@__java_type_names.316 = internal constant [52 x i8] c"android/support/v4/content/pm/ShortcutManagerCompat\00", align 16
@__java_type_names.317 = internal constant [38 x i8] c"android/support/v4/app/ActivityCompat\00", align 16
@__java_type_names.318 = internal constant [63 x i8] c"android/support/v4/app/ActivityCompat$PermissionCompatDelegate\00", align 16
@__java_type_names.319 = internal constant [45 x i8] c"android/support/v4/app/SharedElementCallback\00", align 16
@__java_type_names.320 = internal constant [75 x i8] c"android/support/v4/app/SharedElementCallback$OnSharedElementsReadyListener\00", align 16
@__java_type_names.321 = internal constant [45 x i8] c"crc64a0e0a82d0db9a07d/SingleLocationListener\00", align 16
@__java_type_names.322 = internal constant [55 x i8] c"crc64a0e0a82d0db9a07d/ActivityLifecycleContextListener\00", align 16
@__java_type_names.323 = internal constant [49 x i8] c"crc64a0e0a82d0db9a07d/TextToSpeechImplementation\00", align 16

@java_type_names = local_unnamed_addr constant [324 x i8*] [
	i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__java_type_names.0, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__java_type_names.3, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([56 x i8], [56 x i8]* @__java_type_names.11, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__java_type_names.16, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__java_type_names.32, i32 0, i32 0),
	i8* getelementptr inbounds ([46 x i8], [46 x i8]* @__java_type_names.33, i32 0, i32 0),
	i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__java_type_names.34, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__java_type_names.40, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__java_type_names.88, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__java_type_names.91, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__java_type_names.97, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__java_type_names.199, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__java_type_names.207, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__java_type_names.210, i32 0, i32 0),
	i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__java_type_names.211, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__java_type_names.220, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__java_type_names.234, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__java_type_names.238, i32 0, i32 0),
	i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__java_type_names.239, i32 0, i32 0),
	i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__java_type_names.240, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__java_type_names.246, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__java_type_names.291, i32 0, i32 0),
