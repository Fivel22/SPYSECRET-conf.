...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Task2.ImageAvailableListener, ServicesDemo3", ImageAvailableListener.class, __md_methods);
	}
	...
	public ImageAvailableListener ()
	{
		...
		if (getClass () == ImageAvailableListener.class) {
			mono.android.TypeManager.Activate ("Task2.ImageAvailableListener, ServicesDemo3", "", this, new java.lang.Object[] {  });
		}
	}
